...
export const filterOptions: {name: string, value:FilterStatus}[] =[{value: 'all',name:traductions['all'] },
...formOptions,
];
 export const orderOptions: {value: Orders; name:string}[]=[
  {value:'newest',name:'Mas Nueva a Más Vieja'},
  {value:'oldest', name: 'Mas Vieja a Más Nueva'},
 ];
